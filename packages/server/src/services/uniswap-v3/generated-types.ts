...
export type GetLastDailyDataQuery = { __typename?: 'Query' } & {
    poolDayDatas: Array<
...
export function getSdk<C>(requester: Requester<C>) {
    return {
        getEthPrice(
            variables: GetEthPriceQueryVariables,
            options?: C,
        ): Promise<GetEthPriceQuery> {
            return requester<GetEthPriceQuery, GetEthPriceQueryVariables>(
                GetEthPriceDocument,
                variables,
                options,
            );
        ...
        getLastDailyData(
            variables: GetLastDailyDataQueryVariables,
            options?: C,
        ): Promise<GetLastDailyDataQuery> {
            return requester<
                GetLastDailyDataQuery,
                GetLastDailyDataQueryVariables
            >(GetLastDailyDataDocument, variables, options);
        },
        getPoolDailyData(
            variables: GetPoolDailyDataQueryVariables,
            options?: C,
        ): Promise<GetPoolDailyDataQuery> {
            return requester<
                GetPoolDailyDataQuery,
                GetPoolDailyDataQueryVariables
            >(GetPoolDailyDataDocument, variables, options);
        },
        getPoolHourlyData(
            variables: GetPoolHourlyDataQueryVariables,
            options?: C,
        ): Promise<GetPoolHourlyDataQuery> {
            return requester<
                GetPoolHourlyDataQuery,
                GetPoolHourlyDataQueryVariables
            >(GetPoolHourlyDataDocument, variables, options);
        },
        getPoolOverview(
            variables: GetPoolOverviewQueryVariables,
            options?: C,
        ): Promise<GetPoolOverviewQuery> {
            return requester<
                GetPoolOverviewQuery,
                GetPoolOverviewQueryVariables
            >(GetPoolOverviewDocument, variables, options);
        },
        getPoolsOverview(
            variables: GetPoolsOverviewQueryVariables,
            options?: C,
        ): Promise<GetPoolsOverviewQuery> {
            return requester<
                GetPoolsOverviewQuery,
                GetPoolsOverviewQueryVariables
            >(GetPoolsOverviewDocument, variables, options);
        },
        getPositionSnapshots(
            variables: GetPositionSnapshotsQueryVariables,
            options?: C,
        ): Promise<GetPositionSnapshotsQuery> {
            return requester<
                GetPositionSnapshotsQuery,
                GetPositionSnapshotsQueryVariables
            >(GetPositionSnapshotsDocument, variables, options);
        },
        getPositions(
            variables: GetPositionsQueryVariables,
            options?: C,
        ): Promise<GetPositionsQuery> {
            return requester<GetPositionsQuery, GetPositionsQueryVariables>(
        ...
        getTopPools(
            variables: GetTopPoolsQueryVariables,
            options?: C,
        ): Promise<GetTopPoolsQuery> {
            return requester<GetTopPoolsQuery, GetTopPoolsQueryVariables>(
                GetTopPoolsDocument,
                variables,
                options,
            );
